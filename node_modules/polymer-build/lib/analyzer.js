...
class BuildAnalyzer {
    ...
    printWarnings() {
        for (const warning of this.warnings) {
            ...
            if (warning.severity === polymer_analyzer_1.Severity.ERROR) {
                logger.error(message);
            }
            else if (warning.severity === polymer_analyzer_1.Severity.WARNING) {
                logger.warn(message);
            }
            else {
    ...
    _getDependencies(url) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const importFeatures = doc.getByKind('import', { externalPackages: true, imported: true });
