...
class BehaviorVisitor {
        ...
        for (let i = 0; i < node.properties.length; i++) {
            ...
            if (!name) {
                this.currentBehavior.warnings.push({
                    ...
                    message: `Unable to determine property name from expression of type ${node
                        .type}`,
    ...
    _initBehavior(node, getName) {
        ...
        this._startBehavior(new behavior_1.ScannedBehavior({
            ...
            sourceRange: this.document.sourceRangeForNode(node),
            privacy: js_utils_1.getOrInferPrivacy(symbol, parsedJsdocs, false),
        }));
        ...
        behavior.privacy =
            js_utils_1.getOrInferPrivacy(behavior.className, behavior.jsdoc, false);
