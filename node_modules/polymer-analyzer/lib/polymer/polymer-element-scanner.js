...
class ElementVisitor {
    ...
    enterMethodDefinition(node, _parent) {
        ...
        if (node.kind === 'get') {
            ...
            const propDesc = docs.annotate(js_utils_1.toScannedPolymerProperty(prop, this.document.sourceRangeForNode(node)));
        ...
        if (node.kind === 'method') {
            const methodDesc = docs.annotate(js_utils_1.toScannedMethod(prop, this.document.sourceRangeForNode(node)));
