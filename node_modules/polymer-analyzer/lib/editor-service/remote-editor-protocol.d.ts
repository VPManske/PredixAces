...
export declare type SettledValue = Resolution | Rejection;
...
export declare type Request = InitRequest | FileChangedRequest | GetWarningsRequest | GetDocumentationRequest | GetDefinitionRequest | GetTypeaheadCompletionsRequest | ClearCachesRequest;
...
export interface ClearCachesRequest {
    kind: '_clearCaches';
}
