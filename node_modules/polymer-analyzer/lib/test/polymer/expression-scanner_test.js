    ...
    suite('scanning html for expressions', () => {
      ...
      `;
          ...
          <div id="{{baz}}"></div>
            ...
            chai_1.assert.deepEqual(expressions.map((e) => e.expressionText), ['foo', 'val', 'bada(wing, daba.boom, 10)', 'bar', 'baz']);
...
~~~~~~~~~~~~`
    ...
    suite('parsing expressions from javascript string literals', () => {
      ...
      `;
            ...
            const literals = javascriptDocument.ast.body[0]['declarations'][0]['init']['elements'];
