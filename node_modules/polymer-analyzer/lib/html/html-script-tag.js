...
class ScannedScriptTagImport extends model_1.ScannedImport {
    resolve(document) {
        ...
        if (scannedDocument) {
            const importedDocument = new model_1.Document(scannedDocument, document.analyzer);
            importedDocument._addFeature(document);
            importedDocument.resolve();
            return new ScriptTagImport(this.url, this.type, importedDocument, this.sourceRange, this.urlSourceRange, this.astNode, this.warnings);
        }
        else {
