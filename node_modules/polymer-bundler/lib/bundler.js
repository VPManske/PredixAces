...
class Bundler {
     ...
     */
    bundle(entrypoints, strategy, mapper) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const manifest = yield this._generateBundleManifest(entrypoints, strategy, mapper);
    ...
    _bundleDocument(docBundle, bundleManifest, bundleImports) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // present.
            document = yield this.analyzer.analyze(document.url, parse5_1.serialize(ast));
     ...
     * strategy and mapper.
     */
    _generateBundleManifest(entrypoints, strategy, mapper) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!strategy) {
            ...
            return new bundle_manifest_1.BundleManifest(bundles, mapper);
        });
    }
    /**
    ...
    _inlineStylesheetImports(document, ast) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const cssLink of cssImports) {
                const style = yield importUtils.inlineStylesheet(document, cssLink);
                if (style) {
    ...
    _inlineStylesheetLinks(document, ast) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const cssLink of cssLinks) {
                yield importUtils.inlineStylesheet(document, cssLink);
            }
        });
    }
    /**
    ...
    _moveUnhiddenHtmlImportsIntoHiddenDiv(ast) {
        const unhiddenHtmlImports = dom5.queryAll(ast, dom5.predicates.AND(matchers.htmlImport, dom5.predicates.NOT(matchers.inHiddenDiv)));
    ...
    _prepareBundleDocument(bundle) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!bundle.bundle.files.has(bundle.url)) {
                return yield this.analyzer.analyze(bundle.url, '');
            }
            const document = yield this.analyzer.analyze(bundle.url);
            const ast = clone(document.parsedDocument.ast);
            this._moveOrderedImperativesFromHeadIntoHiddenDiv(ast);
            this._moveUnhiddenHtmlImportsIntoHiddenDiv(ast);
            return yield this.analyzer.analyze(document.url, parse5_1.serialize(ast));
        });
    }
}
