...
;
exports.urlAttrMatchers = constants_1.default.URL_ATTR.map((attr) => dom5_1.predicates.hasAttr(attr));
exports.urlAttrs = dom5_1.predicates.OR.apply(null, exports.urlAttrMatchers);
...
exports.orderedImperative = dom5_1.predicates.OR(exports.htmlImport, exports.jsMatcher, exports.styleMatcher, exports.externalStyle, exports.polymerExternalStyle);
