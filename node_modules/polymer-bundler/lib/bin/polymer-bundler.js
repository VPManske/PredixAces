...
const optionDefinitions = [
    ...
    },
    {
        ...
        type: String,
        multiple: true,
        description: 'Takes an argument in the form of URI|PATH where url is a URI composed of a protocol, hostname, and path and PATH is a local filesystem path to replace the matched URI part with. Multiple redirects may be specified; the earliest ones have the highest priority.'
    },
    {
        name: 'strip-exclude',
        type: String,
...
(() => __awaiter(this, void 0, void 0, function* () {
    ...
    try {
        ...
        if (shell) {
            ...
            strategy = bundle_manifest_1.generateShellMergeStrategy(shell, 2);
        }
        bundles = yield bundler.bundle(entrypoints, strategy);
    }
    catch (err) {
        console.log(err);
        return;
