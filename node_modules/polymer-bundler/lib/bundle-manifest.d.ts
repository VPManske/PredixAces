 ...
 * `{c:[a,b], d:[a], e:[b]}`.
 */
export declare function invertMultimap(multimap: Map<any, Set<any>>): Map<any, Set<any>>;
/**
 ...
 */
export declare function sharedBundleUrlMapper(bundles: Bundle[]): Map<UrlString, Bundle>;
