...
suite('Bundler', () => {
    ...
    suite('Applying strategy', () => {
        test('inlines css/scripts of html imports added by strategy', () => __awaiter(this, void 0, void 0, function* () {
            const bundler = new bundler_1.Bundler({ inlineCss: true, inlineScripts: true });
            // This strategy adds a file not in the original document to the bundle.
            const strategy = (bundles) => {
                bundles.forEach((b) => {
            ...
            const documents = yield bundler.bundle(['test/html/default.html'], strategy);
    ...
    suite('Excludes', () => {
        const htmlImport = preds.AND(preds.hasTagName('link'), preds.hasAttrValue('rel', 'import'));
