...
suite('Bundler', () => {
    ...
    function bundleMultiple(inputPath, strategy, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield bundler.bundle(inputPath, strategy);
        });
    }
    ...
    suite('Sharded builds', () => {
        test('with 3 entrypoints, all deps are in their places', () => __awaiter(this, void 0, void 0, function* () {
            const strategy = bundle_manifest_1.generateSharedDepsMergeStrategy(2);
            const docs = yield bundleMultiple([common, entrypoint1, entrypoint2], strategy);
        ...
        test('with 2 entrypoints and shell, all deps in their places', () => __awaiter(this, void 0, void 0, function* () {
            const strategy = bundle_manifest_1.generateShellMergeStrategy(shell, 2);
            const docs = yield bundleMultiple([shell, entrypoint1, entrypoint2], strategy);
